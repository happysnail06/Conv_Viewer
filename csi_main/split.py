...
# type = 'Active'
type = 'Less_Active'
input_filename = f"public/csi_main/raw/CSI_clothing_{type}_150_2025-02-09.json"
...
dir_name = filename_only.replace("CSI_", "").replace(".json", "")
...
for idx, entry in enumerate(data):
    output_filename = os.path.join(output_dir, f"{type}_{idx}.json")
